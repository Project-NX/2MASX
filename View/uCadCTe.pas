...
uses
  ...
  ACBrCTeDACTEFR, ACBrDFeReport, JvExDBGrids, JvDBGrid, dxSkinsCore,
...
type
  TfrmCadCTe = class(TForm)
    ...
    procedure cxVeiculoClick(Sender: TObject);
    procedure cxRemetenteClick(Sender: TObject);
...
procedure TfrmCadCTe.cxGravarClick(Sender: TObject);
begin
   try
...
procedure TfrmCadCTe.cxImportarClick(Sender: TObject);
begin
...
procedure TfrmCadCTe.cxImprimirClick(Sender: TObject);
begin
   try
    dmCTe.ConfiguraCTe;
...
procedure TfrmCadCTe.cxPessoasClick(Sender: TObject);
begin
   try
...
procedure TfrmCadCTe.cxRemetenteClick(Sender: TObject);
begin
  try
...
procedure TfrmCadCTe.cxTransmitirClick(Sender: TObject);
var
  dir, vCaminho: string;
  Unidade: string;
begin
...
procedure TfrmCadCTe.cxTranspClick(Sender: TObject);
begin
   try
...
procedure TfrmCadCTe.cxVeiculoClick(Sender: TObject);
begin
  try
...
begin
  cxGravar.Enabled := qryCTE_MSITUACAO.Value = 'A';
  cxTransmitir.Enabled := qryCTE_MSITUACAO.Value = 'A';
  cxImprimir.Enabled := (qryCTE_MSITUACAO.Value = 'T');
  cxImportar.Enabled := qryCTE_MSITUACAO.Value = 'A';
