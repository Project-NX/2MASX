...
uses
  ...
  ACBrPosPrinter, dxSkinsCore, dxSkinDevExpressDarkStyle,
...
procedure TfrmBaixaPagarLote.cxGravarClick(Sender: TObject);
begin
...
procedure TfrmBaixaPagarLote.cxSairClick(Sender: TObject);
begin
