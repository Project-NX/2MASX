...
procedure TfrmCadDevolucao.cxFinalizarClick(Sender: TObject);
begin
  DBEdit5.SetFocus;
...
procedure TfrmCadDevolucao.cxGravarClick(Sender: TObject);
begin
   try
...
procedure TfrmCadDevolucao.cxSairClick(Sender: TObject);
begin
