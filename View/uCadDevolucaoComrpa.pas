...
procedure TfrmCadDevolucaoCompra.cxFinalizarClick(Sender: TObject);
begin
  DBEdit5.SetFocus;
...
procedure TfrmCadDevolucaoCompra.cxGravarClick(Sender: TObject);
begin
   try
...
procedure TfrmCadDevolucaoCompra.cxSairClick(Sender: TObject);
begin
