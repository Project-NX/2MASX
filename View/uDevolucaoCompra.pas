...
begin
  ...
  try
    ...
    frmCadDevolucaoCompra.cxGravar.Enabled := true;
    frmCadDevolucaoCompra.cxSair.Enabled := true;
    frmCadDevolucaoCompra.cxFinalizar.Enabled := true;
...
begin
  try
    ...
    frmCadDevolucaoCompra.qryDevolucao.Params[0].Value :=
      qryDevolucaoCODIGO.Value;
    frmCadDevolucaoCompra.qryDevolucao.Open;
    frmCadDevolucaoCompra.cxFinalizar.Enabled := false;
    frmCadDevolucaoCompra.cxGravar.Enabled := false;
    frmCadDevolucaoCompra.cxSair.Enabled := true;
