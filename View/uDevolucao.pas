...
begin
  ...
  try
    ...
    frmCadDevolucao.cxGravar.Enabled := true;
    frmCadDevolucao.cxSair.Enabled := true;
    frmCadDevolucao.cxFinalizar.Enabled := true;
...
begin
  try
    ...
    frmCadDevolucao.qryDevolucao.Params[0].Value := qryDevolucaoCODIGO.Value;
    frmCadDevolucao.qryDevolucao.Open;
    frmCadDevolucao.cxFinalizar.Enabled := false;
    frmCadDevolucao.cxGravar.Enabled := false;
    frmCadDevolucao.cxSair.Enabled := true;
